<template>
    <div id="bookList-container">
        <div class="text-white text-center mt-44">

            <h1 class="m-auto my-8 text-4xl max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl text-shadow-md">Sagas más
                famosas
                del Cosmere</h1>

            <!-- Archivo de las tormentas -->
            <details open class="flex flex-row items-center justify-center w-full">
                <summary
                    class="mb-4 p-2 border border-orange-300 hover:border-gray-500 cursor-pointer w-3/4 m-auto bg-gray-900 rounded">
                    Archivo de las tormentas
                </summary>
            ...
            <!-- Nacidos de la bruma -->
            <details open class="flex flex-row items-center justify-center w-full mt-8">
                <summary
                    class="mb-4 p-2 border border-orange-300 hover:border-gray-500 cursor-pointer w-3/4 m-auto bg-gray-900 rounded">
                    Nacidos de la bruma
                </summary>
            ...
            <!-- Novelas secretas -->
            <details open class="flex flex-row items-center justify-center w-full mt-8 mb-40">
                <summary
                    class="mb-4 p-2 border border-orange-300 hover:border-gray-500 cursor-pointer w-3/4 m-auto bg-gray-900 rounded">
                    Novelas secretas
                </summary>
